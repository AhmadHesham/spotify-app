...
public class Compile extends Command {
    ...
    public void execute() throws Exception {
        try {
            ...
            String commandPrefix = type.equals("user") ? "Auth/src/main/java/api/commands/"
                    : "Auth/src/main/java/controller/";
            ...
            String destination = type.equals("user") ? "Auth/target/classes/" : "Auth/target/classes/";
