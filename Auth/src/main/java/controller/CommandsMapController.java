...
public class CommandsMapController {
    ...
    public static void initialize() throws Exception {
        ...
        try {
            prop.load(CommandsMapController.class.getClassLoader().getResourceAsStream("AuthController.properties"));
...
//    }
    ...
    public static void replace(String key, Class<?> cls, String fileName) {
        if (cmdMapController.containsKey(key)) {
            ...
            try {
                prop.store(new FileOutputStream("Auth/src/main/resources/AuthController.properties"), null);
            } catch (IOException e) {
