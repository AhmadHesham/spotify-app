...
public class Compile extends Command {
    ...
    public void execute() throws Exception {
        try {
            ...
            String commandPrefix = type.equals("user") ? "Art/src/main/java/api/commands/"
                    : "Art/src/main/java/controller/";
            ...
            String destination = type.equals("user") ? "Art/target/classes/" : "Art/target/classes/";
